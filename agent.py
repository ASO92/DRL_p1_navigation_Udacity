...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, dueling=False, double=False):
        ...
        ======
            ...
            activate_dueling(bool): True for dueling agent. Variable to QNetwork
            activate_Double(bool): True for DDQN agent
        """
        self.state_size = state_size  # 37 for banana
        self.action_size = action_size # 4 for banana
...
## Testing
# A1 = Agent(state_size = 4, action_size = 3, seed = 0)
# print(A1)